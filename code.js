...
pokeForm.addEventListener("submit", event => {
    ...
    let button = document.querySelector('.pokeform-button');
    button.addEventListener("mouseover", () => {
        button.style.backgroundImage = "url(https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Pok%C3%A9_Ball_icon.svg/512px-Pok%C3%A9_Ball_icon.svg.png?20161023215848)";
    });
